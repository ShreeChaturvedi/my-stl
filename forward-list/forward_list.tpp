template <typename T> ForwardList<T>::ForwardList() noexcept : head_{} {}
...
template <typename T> ForwardList<T>::ForwardList(ForwardList&& other) noexcept : ForwardList() {
...
template <typename T> bool ForwardList<T>::empty() const noexcept {
...
template <typename T> template <typename... Args> T& ForwardList<T>::emplace_front(Args&&... args) {
...
template <typename T> typename ForwardList<T>::iterator ForwardList<T>::before_begin() noexcept {
...
template <typename T> typename ForwardList<T>::iterator ForwardList<T>::begin() noexcept {
...
template <typename T> typename ForwardList<T>::iterator ForwardList<T>::end() noexcept {
  return iterator(nullptr);
}

template <typename T> typename ForwardList<T>::const_iterator ForwardList<T>::end() const noexcept {
...
template <typename T> typename ForwardList<T>::iterator ForwardList<T>::erase_after(iterator pos) {
...
template <typename T> void ForwardList<T>::steal(ForwardList&& other) noexcept {
